  ...
  if (!sessions.length) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">No Session Requests</h3>
        <p className="text-gray-500 text-sm">You don't have any {status} session requests at the moment.</p>
      </div>
    );
  }
  ...
  return (
     <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6 mb-2">
      {sessions.map((session) => (
        <div
          key={session._id}
          className="bg-white border border-gray-200 rounded-md shadow-sm hover:shadow-md transition-shadow duration-200"
        >
          {/* Header */}
          <div className="border-b border-gray-200 px-4 py-3 bg-gray-50">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 text-[10px] font-medium rounded border border-gray-300 text-gray-600 capitalize">
                  {status}
                </span>
              </div>
              ...
              <div className="bg-white rounded-md p-3 mb-4 border border-gray-200">
                ...
                {session.post.specificTopic && (
                  <div className="bg-gray-50 rounded p-2 border mb-2">
                    <p className="text-[10px] text-gray-500 uppercase">Topic Details</p>
...
export default ProfileRequestSession;