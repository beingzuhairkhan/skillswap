  ...
  if (!sessions.length) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-2">No Rejected Sessions</h3>
        <p className="text-gray-500 text-sm">You don't have any rejected sessions at the moment.</p>
      </div>
    );
  }
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6 max-w-5xl mx-auto mb-2">
      {sessions.map((session) => (
        ...
        >
          ...
          <div className="px-4 py-3 bg-gray-50 border-b border-gray-200">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 text-[10px] font-semibold rounded-md bg-red-100 text-red-700 capitalize">
                  Rejected
                </span>
              </div>
          ...
          <div className="p-4">
            {/* Rejection Notice */}
            <div className="bg-red-50 border-l-4 border-red-500 rounded-md p-3 mb-4">
              <div className="flex items-start gap-2">
                <XCircle className="w-4 h-4 text-red-600 mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="text-xs font-semibold text-red-900 mb-1">Session Rejected</h4>
                  <p className="text-xs text-red-700">
                    This session request was not approved. You may contact the other participant for more details.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 mb-4">
              ...
              <div className="border rounded p-2 text-center">
                ...
                <p className="text-xs font-semibold text-red-600 capitalize">Rejected</p>
              </div>
            </div>
...
export default ProfileCancelSession;