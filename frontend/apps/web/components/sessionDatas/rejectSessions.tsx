  ...
  useEffect(() => {
    const fetchRejectSessions = async () => {
      try {
        ...
        toast.error("Failed to load rejected sessions");
      } finally {
        setLoading(false);
      }
    };
    ...
    <div className="flex gap-6 bg-white">
      ...
      <div className="w-1/4">
        <div className="border rounded-lg shadow-sm bg-gray-50 p-4 h-[600px] flex flex-col">
          <h3 className="font-semibold text-lg mb-4">Rejected Sessions</h3>
          ...
          <div className="border rounded-lg shadow-sm p-6 bg-white ">
            ...
            <div className="bg-gray-50 p-4 rounded-md mb-6">
              <p className="text-sm text-gray-600">
                The session on{" "}
                <strong>
                  {selectedSession.postId?.wantToLearn}
                </strong>{" "}
                scheduled for{" "}
                <em>
